...
public class XmlSchemaLoader : SchemaLoaderBase
{
    ...
    private readonly List<string> _tableOptionalAttrs = new() { "index", "mode", "group", "comment", "readSchemaFromFile", "output", "tags","mysqltablename" };
    ...
    private void AddTable(XElement e)
    {
        ...
        string mysqlTableName = XmlUtil.GetOptionalAttribute(e, "mysqltablename");
        Collector.Add(SchemaLoaderUtil.CreateTable(_fileName, name, module, valueType, index, mode, group, comment, defineFromFile, input, tags, output, mysqlTableName));
    }
    ...
    protected RawField CreateField(XElement e)
    {
        ...
        return SchemaLoaderUtil.CreateField(_fileName, XmlUtil.GetRequiredAttribute(e, "name"),
            ...
            false,
            XmlUtil.GetOptionalAttribute(e, "sfieldname")
        );
    }
